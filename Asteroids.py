...
debris_image = random.choice([simplegui.load_image("http://commondatastorage.googleapis.com/codeskulptor-assets/lathrop/debris1_brown.png"),
...
nebula_image = random.choice([simplegui.load_image("http://commondatastorage.googleapis.com/codeskulptor-assets/lathrop/nebula_brown.png"),
                simplegui.load_image("http://commondatastorage.googleapis.com/codeskulptor-assets/lathrop/nebula_blue.f2013.png")])
...
explosion_image = (simplegui.load_image("http://commondatastorage.googleapis.com/codeskulptor-assets/lathrop/explosion_alpha.png"),
                   ...
                   simplegui.load_image("http://commondatastorage.googleapis.com/codeskulptor-assets/lathrop/explosion_orange.png"),
...
def group_collide(group, other_object):
    for i in group:
        if i.collide(other_object) == True:
            a_explosion = Sprite(i.pos, [0, 0], 0, 0, random.choice(explosion_image), explosion_info, explosion_sound)
...
def draw(canvas):
    ...
    # draw UI
    canvas.draw_text("Lives", [50, 50], 25, "White", "monospace")
    canvas.draw_text("Score", [680, 50], 25, "White", "monospace")
...
def rock_spawner():
    ...
    a_rock = Sprite(rock_pos, rock_vel, 0, rock_avel, random.choice(asteroid_image), asteroid_info)
